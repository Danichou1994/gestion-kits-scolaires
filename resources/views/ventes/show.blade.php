        ...
        <div class="section-break-ok">
            ...
            <table class="w-full border-collapse mb-6">
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="3" class="p-2 text-right">Commission (10%)</td>
...
<div class="section-no-break">
    ...
    <table class="w-full mb-4 border-collapse page-table">
        
        @if($vente->mode_paiement == 'tontine')
        {{-- 🔥 POUR TONTINE : Acompte + Solde + Mensualités --}}
        <tr class="border-b">
        ...
        @else
        {{-- 🔥 POUR COMPTANT : Montant total payé --}}
        <tr class="border-b">
            <td class="p-2"><strong>Montant total</strong></td>
...
<div class="section-no-break">
    ...
    <table class="w-full border-collapse mb-6 page-table">
        <thead>
...
@endif
       <!-- ========================================== -->
<!-- 💰 COMMISSION TONTINE - UNIQUEMENT POUR TONTINE -->
<!-- ========================================== -->
@if($vente->mode_paiement == 'tontine')
...
<div class="border-2 border-blue-300 bg-blue-50 p-4 rounded-lg mb-6 section-no-break">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="bg-white p-3 rounded-lg section-no-break">
            ...
            <table class="w-full text-sm page-table">
                <tr class="border-b">
                ...
                {{-- 🔥 MENSUALITÉS UNIQUEMENT POUR TONTINE --}}
                @if($vente->mode_paiement == 'tontine')
                <tr class="border-b">
